...
r_general = {"Small Antechamber": "The walls drip with blood.", 
...
r_latrine = {"Bathing Chamber":"This is a normal bathroom with a simple pedistal sink, a toilet, and a clawfoot tub.",
...
r_closet = {"Coat Closet": "This is just a closet used to store the winter coats.", 
...
r_kitchen = {"Small Kitchen": "The room smells of fresh baked bread, but the cupboards lay open and bare.", 
...
r_laundry = {"Servent's Laundryroom": "This dank and mildewy room was once used to wash the servents clothes. Faded livery hangs from rope strung across the room.",
...
r_dining = {"Family Diningroom": "This is a smaller dining hall reserved for more intimate dining. The table is set with fine china and silverware.",
...
r_sleeping = {"Servents Quarters": "This room must have been used to house servents. A few small beds with straw matresses line the wall. Between the beds sit simple nightstands.",
...
r_library =  {"Scholar's Library": "The room smells of old books and warm fires. Shelves laden with books line the walls for several stories.", 
...
r_gallery = {"Portrait Gallery": "The walls are lined with portraits of long dead nobles with forboding countenences",
...
r_conservatory = {"Lush Conservatory": "This room is made of glass and lush vegitation abounds. Creeping vines have taken over the walkways and furniture.  But, a question arises: who is watering all of these plants?",
...
r_laboratory = {"Abandoned Labaoratory": "Broken glass is scattered across the floor and counters. Strange bubbling liquid fills jars that line the shelves.",
...
r_passageway = {"Paneled Passageway": "Within one of the wood panels there was a small brass keyhole",
...
r_observatory = {"Observation Tower": "A small cot was pushed to the wall on one side.",
...
r_armory = {"Armor Room": "Several suits of armor stood majestically in each corner.  Did one of them just move?", 
...
r_sickroom = {"Sickroom": "Rows of beds line the walls.  Some with linen, some without",
              "Retiring Room": "Several basins are on a long woden table. The last basin is still full of water",
              "A mattress stained wth blood is hidden behind a folding wall divider.  A rumpled uniform jacket lay across the end of the bed.",
              "Supply Room": "Boxes of pills, needles, and bandages filled several shelves. Omanus looking saws stood ajar"}

r_trainingroom = {"Sparring Room": "A big mat covers the floor on one side.",
...
r_greenhouse = {"Several glass panes contained large cracks or were missing altogether",
                "Many of the plants were wilted and dead",
                "A hearty green bush with small yellow flowers filled one side",
                "A wooden table covered in dirt and rusting tools must have been used to do the planting",
                "The wooden door seemed to be stuck.  Pulling it hard got it open."}

"r_ chapel" = {"Nave": "The rows of polished pews flanked a beautiful blue carpet.",
             "Chancel Arch": "The large wooden and metal cross radiated peace and safety.",
             "Back Pew": "Between one of the pews was evidence of someone had been sleeping there.",
             "Choir": "Hymm books were placed on the tables."}

"r_ rookery" : ("Dozens of rooks nested in a clump of trees.",
              "A chilled pond was behind the clump of trees.",
              "The path of gravel lead to a green house.",
              "Between one of the pews was evidence of someone had been sleeping there.",
              "Hymm books were placed on the choir tables.")

"r_ warroom" : ("The huge double doors wear ajar.",
              "The elaborate walls of the octagonal room were filled with paintings of past kings",
              "A large eight sided war table sat in the center of the room.",
              "The engravings in the table showed the sorrounding lands.",
              "The table was covered with small figuriens showing the location of an army.")

"r_ winecellar" : ("The arched ceiling was made of brick",
                "Rows of wooden wine barrels were stacked in groups of three.,
                "The cobblestone floor was covered with loose sand.,
                "Torches attached to the walls flickered every few steps."
                "Small dark alcoves were filled with dark bottles filled with spirits.")

"r_greatroom" : ("Hunters trophies covered the back wall.",
                "A breeze came through the many windows that lined one wall.",
                "A pot hung on a hook within the huge fireplace.",
                "The doors in the back of the room would not open.",
                "Dusty wooden bowls and metal plates were on the long tables.")
}